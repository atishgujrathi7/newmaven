                    ...
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            <form  action="LaborController.spring" autocomplete="on"> 
                             <h3>Agro-Labor Management System</h3>
                                <h1> Sign up </h1> 
                                <p> 
                                ...
                                <p> 
                                    ...
                                    <input id="lgender" name="lgender" required="required" type="text" placeholder="eg. Male/Female"/>
                                </p>
                                
                                <p> 
                                    <label for="dobsignup_confirm" class="youdob" >Date of Birth </label>
                                    <input id="ldob" name="ldob" required="required" type="text" placeholder="eg. 16/02/1995"/>
                                </p>
                                
                                <p> 
                                    <label for="locationsignup_confirm" class="youlocation" >Location </label>
                                    <input id="lloc" name="lloc" required="required" type="text" placeholder="eg. pune"/>
                                </p>
                                
                                <p> 
                                    <label for="wagessignup_confirm" class="youwages" >Wages </label>
                                    <input id="lwages" name="lwages" required="required" type="text" placeholder="eg. 100"/>
                                </p>
